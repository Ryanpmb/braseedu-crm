              ...
              <CardContent>
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between items-center pt-2 border-t">
                    ...
                    <span className="text-sm font-bold text-foreground">{salesman.opportunitiesQuantities ? Math.round(salesman.closedSales / salesman.opportunitiesQuantities * 100) + '%' : 0 + '%'}</span>
                  </div>
                </div>
              </CardContent>
            </Card>
